...
class FeType extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['class','description','remark'], 'string', 'max' => 255],
            [['status'], 'safe'],
    ...
    {
        $query = new \backend\models\query\FeTypeQuery(get_called_class());
        ...
        return $query->andWhere(['fe_type.deleted_by' => 0]);
    }
