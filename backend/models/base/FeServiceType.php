...
class FeServiceType extends ActiveRecord
{
    ...
    {
        $query = new \backend\models\query\FeServiceTypeQuery(get_called_class());
        ...
        return $query->andWhere(['fe_service_type.deleted_by' => 0]);
    }
}
