...
class Company extends ActiveRecord
{
    ...
    {
        return [
            [['id','poscode','created_at','updated_at','created_by','updated_by','deleted_at','deleted_by'], 'integer', 'size' => 11],
            [['reg_no','name','email','contact','address','state','country'], 'string', 'max' => 255],
            [['status'], 'safe'],
        ];
    }
