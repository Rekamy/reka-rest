...
class Migration extends ActiveRecord
{
    ...
    {
        $callback = is_array($callback) ? $callback : self::find()->orderBy('migration.id')->asArray()->all();
        return \yii\helpers\ArrayHelper::map($callback, 'id', 'migration.name');
    }
    ...
    public static function find()
    {
        ...
        return $query->andWhere(['migration.deleted_by' => 0]);
    }
