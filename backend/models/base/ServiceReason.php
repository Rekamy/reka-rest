...
class ServiceReason extends ActiveRecord
{
    ...
    {
        $query = new \backend\models\query\ServiceReasonQuery(get_called_class());
        ...
        return $query->andWhere(['service_reason.deleted_by' => 0]);
    }
