...
class OrderItemType extends ActiveRecord
{
    ...
    {
        $query = new \backend\models\query\OrderItemTypeQuery(get_called_class());
        ...
        return $query->andWhere(['order_item_type.deleted_by' => 0]);
    }
