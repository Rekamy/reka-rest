...
class FeServiceStatus extends ActiveRecord
{
    ...
    {
        $query = new \backend\models\query\FeServiceStatusQuery(get_called_class());
        ...
        return $query->andWhere(['fe_service_status.deleted_by' => 0]);
    }
}
