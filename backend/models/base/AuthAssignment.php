...
class AuthAssignment extends ActiveRecord
{
    ...
    {
        $query = new \backend\models\query\AuthAssignmentQuery(get_called_class());
        ...
        return $query->andWhere(['auth_assignment.deleted_by' => 0]);
    }
