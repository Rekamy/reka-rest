	        ...
	        <div id="chatapp" class="col s12">
	          <div class="collection border-none">
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-1.png" alt="" class="circle cyan">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-2.png" alt="" class="circle deep-orange accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-3.png" alt="" class="circle teal accent-4">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-4.png" alt="" class="circle cyan">
	              <span class="line-height-0">June Lane </span>
	              <span class="medium-small right blue-grey-text text-lighten-3">4.14 AM</span>
	              <p class="medium-small blue-grey-text text-lighten-3">Ohh God </p>
	            </a>
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-5.png" alt="" class="circle red accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-6.png" alt="" class="circle deep-orange accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-7.png" alt="" class="circle cyan">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-8.png" alt="" class="circle red accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-9.png" alt="" class="circle teal accent-4">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-2.png" alt="" class="circle red accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-4.png" alt="" class="circle red accent-2">
	            ...
	            <a href="#!" class="collection-item avatar border-none">
	              <img src="dist-asset/materialize/images/avatar/avatar-5.png" alt="" class="circle cyan">
